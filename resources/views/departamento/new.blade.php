   ...
   <body>
     ...
     <form method="POST" action="{{ route('departamentos.store') }}">
         ...
         <div class="mb-3">
           ...
           <div id="idHelp" class="form-text">depart code</div>
         </div>
         <div class="mb-3">
           <label for="name" class="form-label">depart</label>
           <input type="text" required class ="form-control" id="name" aria-describedby="nameHelp" name="name" placeholder="depart name.">
         </div>
